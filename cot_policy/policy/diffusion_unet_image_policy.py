...
from cot_policy.model.diffusion.mask_generator import LowdimMaskGenerator
...
class DiffusionUnetImagePolicy(BaseImagePolicy):
        ...
        **kwargs,
        ...
        for t in scheduler.timesteps:
            ...
            trajectory = scheduler.step(
                model_output, t, trajectory, generator=None, **kwargs
            ).prev_sample
            gen_traj.append(trajectory)
    ...
    def predict_action(
        ...
        # run sampling
        nsample, gen_traj = self.conditional_sample(
            cond_data,
            cond_mask,
        ...
        result = {"action": action, "action_pred": action_pred, "gen_traj": gen_traj}
        return result
