...
from cot_policy.env.dm_control.ballincup_image_env import BallInCupImageEnv
...
class BallInCupImageRunner(BaseImageRunner):
    def __init__(
        self,
        output_dir,
        n_train=10,
        ...
        def env_fn():
            return MultiStepWrapper(
                VideoRecordingWrapper(
                    BallInCupImageEnv(render_size=render_size),
    ...
    def run(self, policy: BaseImagePolicy):
        ...
        for chunk_idx in range(n_chunks):
            ...
            pbar = tqdm.tqdm(
                ...
                desc=f"Eval BallInCupImageRunner {chunk_idx+1}/{n_chunks}",
                leave=False,
